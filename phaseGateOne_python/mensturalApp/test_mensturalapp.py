...
class TestDateFunctions(unittest.TestCase):
    ...
    def test_predict_ovulation_period(self):
        start = date(2025, 6, 6)
        expected = [date(2025, 6, 20), date(2025, 6, 21), date(2025, 6, 22), date(2025, 6, 23), date(2025, 6, 24), date(2025, 6, 25)]
        self.assertEqual(function_mensturalapp.predict_ovulation_period(start), expected)

    def test_safe_periods(self):
        start = date(2025, 6, 6)
        expected = [date(2025, 6, 12), date(2025, 6, 13), date(2025, 6, 14), date(2025, 6, 15)]
